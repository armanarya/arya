...
// ============================================================
// ARYA — Personal Optimization Agent · v5
// Unified habits · Ring · Month calendar · Workout logger
// ============================================================

const STORAGE_KEY = "arya:v5:state";
...
const DEFAULT_STATE: State = {
  ...
  dailyHabits: [
    ...
    { id: "skin-am-cleanser", label: "AM · Effaclar cleanser", detail: "La Roche-Posay Effaclar Gel. Lather 15 sec.", icon: "droplet", xp: 3, section: "skin" },
    { id: "skin-am-vitc", label: "AM · Vitamin C serum", detail: "The Ordinary 8% Ascorbic Acid + Alpha Arbutin.", icon: "sun", xp: 3, section: "skin" },
    { id: "skin-am-eye", label: "AM · Multi-peptide eye serum", detail: "The Ordinary Multi-Peptide. Ring finger, light touch.", icon: "eye", xp: 3, section: "skin" },
    { id: "skin-am-moisturizer", label: "AM · Moisturizer", detail: "The Ordinary NMF. On slightly damp skin.", icon: "droplet", xp: 3, section: "skin" },
    { id: "skin-am-spf", label: "AM · EltaMD SPF 50", detail: "Face + neck + ears + forearms. Non-negotiable.", icon: "sun", xp: 10, section: "skin" },
    { id: "skin-pm-cleanser", label: "PM · Cleanser", detail: "Effaclar gel, or Glucoside foaming on light nights.", icon: "moon", xp: 3, section: "skin" },
    { id: "skin-pm-treatment", label: "PM · Treatment (SA or Niacinamide)", detail: "Salicylic 2% on breakout zones (3x/wk). Niacinamide other nights.", icon: "moon", xp: 3, section: "skin" },
    { id: "skin-pm-eye", label: "PM · Multi-peptide eye serum", detail: "Second daily application.", icon: "eye", xp: 3, section: "skin" },
    { id: "skin-pm-moisturizer", label: "PM · Moisturizer", detail: "NMF. Seal everything in.", icon: "moon", xp: 3, section: "skin" },
        ...
        <header className="mb-6">
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <div className="text-[10px] tracking-[0.3em] text-white/30 uppercase mt-1">v5 · Optimization Agent</div>
            </div>
